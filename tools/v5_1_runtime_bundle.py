...
DIRECT_RENDERER_CAPTURE_FAILURE_STAGES = {
    ...
    "first-context-direct-renderer-post-validation-input",
    "first-context-direct-renderer-post-validation-schema",
    "first-context-direct-renderer-post-validation-identity",
