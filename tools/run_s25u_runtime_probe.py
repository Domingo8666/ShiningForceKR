...
RUNTIME_FAILURE_STAGES = {
    ...
    "source-target-structural-corroboration",
    "structural-corroboration-identity",
    "structural-corroboration-pair",
    "structural-corroboration-speaker",
    "structural-corroboration-token",
    "structural-corroboration-input",
    "structural-corroboration-validation",
    "source-target-runtime-sequence",
    "runtime-sequence-identity",
    "runtime-sequence-anchor",
    "runtime-sequence-observation",
    "runtime-sequence-input",
    "runtime-sequence-validation",
    "source-target-runtime-context",
    "runtime-context-identity",
    "runtime-context-mapping",
    "runtime-context-input",
    "runtime-context-validation",
    "runtime-context-glyph-demand",
    "context-glyph-demand-identity",
    ...
    "active-ram-register-trace",
    "active-ram-register-trace-initialize",
    "active-ram-register-trace-load-media",
    ...
    "first-context-translated-vram-diff",
    ...
    "context-glyph-candidates-input",
    "context-glyph-candidates-validation",
    "runtime-context-glyph-review",
    "context-glyph-review-identity",
    "context-glyph-review-mapping",
    "context-glyph-review-input",
    "context-glyph-review-validation",
    "runtime-context-glyph-preservation",
    "context-glyph-preservation-identity",
    "context-glyph-preservation-classification",
    "context-glyph-preservation-input",
    "context-glyph-preservation-validation",
    "first-context-translation-review",
    "first-context-review-identity",
    "first-context-review-mapping",
    "first-context-review-input",
    "first-context-review-validation",
    "first-context-translation-approval",
    "first-context-approval-identity",
    "first-context-approval-payload",
    "first-context-approval-input",
    "first-context-approval-validation",
    "first-context-translation-capacity",
    "first-context-capacity-identity",
    "first-context-capacity-font-plan",
    "first-context-capacity-input",
    "first-context-capacity-validation",
    "first-context-translation-encoding",
    "first-context-encoding-identity",
    "first-context-encoding-plan",
    "first-context-encoding-input",
    "first-context-encoding-validation",
    "first-context-record-reinsertion",
    "first-context-reinsertion-identity",
    "first-context-reinsertion-record",
    "first-context-reinsertion-row-count",
    "first-context-reinsertion-duplicate-projection",
    "first-context-reinsertion-invalid-projection",
    "first-context-reinsertion-invalid-context-row",
    "first-context-reinsertion-missing-target-record",
    "first-context-reinsertion-invalid-record-fields",
    "first-context-reinsertion-record-bounds",
    "first-context-reinsertion-input",
    "first-context-reinsertion-validation",
    "first-context-translation-build",
    "first-context-build-identity",
    "first-context-build-write",
    "first-context-build-group-alias",
    "first-context-build-group-tail",
    "first-context-build-group-overflow",
    "first-context-build-group-identity",
    "first-context-build-verification",
    "first-context-build-input",
    "first-context-build-validation",
    "first-context-translation-runtime-capture",
    "first-context-runtime-capture-identity",
    "first-context-runtime-capture-sequence",
    "first-context-runtime-capture-input",
    "first-context-runtime-capture-validation",
    ...
    "first-context-runtime-capture-review-write",
    "first-context-runtime-capture-review-count",
    "first-context-runtime-capture-review-path",
    "first-context-runtime-capture-review-file-write",
    "first-context-runtime-capture-local-write",
    "first-context-runtime-capture-safe-build",
    "first-context-runtime-capture-safe-write",
