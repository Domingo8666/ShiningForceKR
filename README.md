...
스크립트 쪽으로 거슬러 올라갑니다. 이 단계는 Start를 누르면 도입 장면을
건너뛰므로 약 12,000프레임 동안 컨트롤러 입력 없이 attract intro를
기다립니다. S25U에서 0x5F 전용 페이지 렌더러 호출이 관측되지 않으면
그보다 앞선 공용 텍스트 디코더 0x003411을 추적합니다. 디코더 히트 직후
slot 1·2의 ROM data read를 최대 64개의 고유 물리 좌표로 수집해 한국어
