...
11. 진행 중: 실제 디코더 스트림 0x0203DE와 0x0203E8의 `한다` 화면 시험은 모두 문구 미표시로 실패했습니다. 두 스트림을 누적 제외했고, 기존 표본의 남은 스트림은 비트 예산이 부족하므로 source-region 읽기 표본을 32개로 확대해 다음 안전 후보를 수집합니다.
