...
11. 사람 검토 대기: 실제 디코더 스트림 0x0203DE·0x0203E8·0x020447·0x020462·0x020473은 문구 미표시로 실패했습니다. 다음 87비트 후보 0x0204B1은 기준·시험 화면에서 최대 459픽셀 변화가 확인됐고 진행 후 화면은 기준과 같습니다. 병행 자동실행은 0x33FA 진입 선택자를 재수집하며, `reports/HUMAN_REVIEW/`의 PNG 3개에서 `한다` 자형과 주변 UI를 확인합니다.
