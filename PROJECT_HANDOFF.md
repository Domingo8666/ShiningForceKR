...
12. 다음 자동 단계: 0x33FA 진입에서 DE=2인 호출을 다시 잡고 ROM 바이트·opcode를 제외한 PC·AF·BC·DE·HL·SP·매퍼 상태만 192명령 기록합니다. 이 짧은 동적 추적으로 `INC B`의 실제 역할과 출력 버퍼 연결을 먼저 확정한 뒤 새 화면 시험을 만듭니다.
