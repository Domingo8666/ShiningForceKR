...
4. 0x5F 전용 페이지 렌더러 호출보다 앞선 공용 텍스트 디코더 0x003411의 세 매핑을 한 콜드 부팅에서 동시에 감시하고, Start 뒤 2번 확인 버튼으로 새 게임 스토리를 진행합니다. 히트 직후 slot 1·2 ROM read를 넓게 포착해 논리 주소, 매퍼 뱅크, 물리 좌표와 로컬 trace를 연결합니다.
