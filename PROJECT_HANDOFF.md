...
4. BPS에서 tree bank 0x20으로 패치된 디코더 영역의 0x33FA·0x3411·0x3431 execute 후보를 한 콜드 부팅에서 감시합니다. 진입 직후에만 짧은 CPU trace와 slot 1·2 ROM read를 켜서 한국어 Huffman 벡터 물리 0x080100..0x0802FF의 실제 소비를 확인합니다.
