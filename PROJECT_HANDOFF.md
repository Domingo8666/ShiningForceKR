...
4. 검증된 한국어 Huffman 벡터 물리 0x080100..0x0802FF가 slot 1 또는 2에 bank 0x20으로 매핑된 실제 read를 한 콜드 부팅에서 동시에 감시하고, Start 뒤 2번 확인 버튼으로 새 게임 스토리를 진행합니다. 히트 PC와 후속 ROM read를 넓게 포착해 논리 주소, 매퍼 뱅크, 물리 좌표와 로컬 trace를 연결합니다.
