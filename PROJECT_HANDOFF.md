...
11. 자동 재검증 중: DE=2·B=147의 148번째 엔트리 가정은 목표 read가 재현되지 않아 철회했습니다. 실제 read 0x0204B1을 포함하는 유일한 23번째 엔트리 물리 0x02049F bit 6부터 길이를 보존한 200비트 `한다`를 넣고 같은 콜드 부팅 경로를 다시 캡처합니다.
