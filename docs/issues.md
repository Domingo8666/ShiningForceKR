...
| SFKR-036 | 픽셀 변화가 난 0x0204B1 stream을 상위 디코더 블록 엔트리와 연결하지 못함 | fixed-static | 목표 read 순간 DE와 0x3FE8 포인터 테이블의 현재·다음 포인터를 대조해 블록 엔트리 번호와 블록 내 오프셋을 기록하고 S25U 재확인 |
