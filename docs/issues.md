...
| SFKR-021 | 무입력 attract 경로는 공용 텍스트 디코더 0x003411에 도달하지 않고, 이전 새 게임 자동 조작은 확인이 아닌 1번 취소 버튼을 반복함 | fixed-static | 콜드 부팅 뒤 Start와 2번 확인 버튼으로 스토리를 진행하며 디코더 세 매핑을 S25U에서 재추적 |
