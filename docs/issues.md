...
| SFKR-008 | 실제 스크립트 조회표 미확정 | investigating | 디코더 호출부와 포인터/뱅크 테이블 추적 |
| SFKR-009 | 0x80 이상 단어 사전 토큰 미확정 | investigating | 소비 코드와 사전 후보 함께 검증 |
| SFKR-010 | 목표 인트로 문장 ROM 디코딩 미완료 | blocked | SFKR-008과 SFKR-009 완료 후 재개 |
