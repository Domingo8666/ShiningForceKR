...
| SFKR-036 | DE=2·B=147을 곧바로 148번째 선택 대사의 서수로 가정 | investigating | 추정한 0x49E0·0x49E1 read가 같은 화면 경로에서 관측되지 않았으므로 B 의미를 확정하지 않음. 실제 0x44B1 read를 포함하는 유일 후보 23번째 엔트리(bit 1550..1750)를 직접 교체해 표시 여부 재검증 |
