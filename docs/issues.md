...
| SFKR-027 | 단일 프레임 장벽으로 완료한 Start·2번 3,300프레임 경로에서 상위 정적 조회표 후보의 매퍼 일치 read가 0회 | investigating | 장거리 trace를 끈 채 패치된 디코더 execute 후보를 잡고 진입 직후의 짧은 slot 1·2 ROM read를 수집 |
