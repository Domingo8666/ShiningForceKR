...
| SFKR-036 | 픽셀 변화가 난 0x0204B1 stream에서 관측한 B=147을 엔트리 서수로 오해 | investigating | 0x43DE부터 B+1개 엔트리의 무변경 연속 왕복은 통과했지만 148번째 엔트리는 0x49E0..0x49EE여서 0x44B1을 포함하지 않음. 같은 prefix 안에서 0x44B1과 겹치는 실제 엔트리 후보를 독립 계산하고 B의 의미를 후속 제어 흐름으로 추적 |
