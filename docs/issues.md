...
| SFKR-043 | 디코더 진입의 B=147 의미와 0x43DE.. 런타임 read 묶음의 종료 조건이 미확정 | investigating | B+1=148개 고정 출력 심벌 해석은 0x44B1 read 범위에 도달하지 못해 기각. DE=2 호출에서 ROM 바이트 없는 192명령 PC·레지스터 추적으로 BC·DE·HL 역할과 출력 버퍼 연결을 판정 |
